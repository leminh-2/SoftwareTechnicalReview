...
public class LoginState extends WarehouseState{
    ...
    public int getCommand() {
        ...
        do {
            try {
                int value = Integer.parseInt(getToken(reader, "Enter command:" ));
    ...
    public String getToken(BufferedReader reader, String prompt) {
        do {
            try {
    ...
    private boolean yesOrNo(String prompt) {
        BufferedReader reader = new BufferedReader(new InputStreamReader(System.in));
        String more = getToken(reader, prompt + " (Y|y)[es] or anything else for no");
    ...
    private void clerk(){
        ...
        if (verifyPassword(userName, password, "clerk")) {
    ...
    private void manager(){
        ...
        System.out.println("Enter Password: ");
        String password = scanner.nextLine();
        if(verifyPassword(userName, password, "manager")) {
    ...
    private void user(){
        BufferedReader reader = new BufferedReader(new InputStreamReader(System.in));
        String userID = getToken(reader, "Please input the user id: ");
